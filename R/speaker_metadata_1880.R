#' The 19th-century British Parliamentary debates speaker metadata for the decade 1880
#'
...
#' @docType data
#'
#' @usage speaker_metadata_1880
#'
#' @format A data frame with 1713215 rows and 6 variables:
#'
#' sentence_id
