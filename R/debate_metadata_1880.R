#' The 19th-century British Parliamentary debates metadata for the decade 1880
#'
...
#' @docType data
#'
#' @usage debate_metadata_1880
#'
#' @format A data frame with 1811519 rows and 5 variables:
#'
#' sentence_id
