...
#'
#' Hansard corpus data for the decade 1820. To also access information about speaker, date, and debate title, join this data frame with debate_metadata on
...
#' @usage hansard_1820
#'
#' @format A data frame with 342269 rows and 2 variables:
#'
#' sentence_id
