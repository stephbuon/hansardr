#' The 19th-century British Parliamentary debates for the decade 1830
#'
#' Hansard corpus data for the decade 1830. To also access information about speaker, date, and debate title, join this data frame with debate_metadata on
...
#' @usage hansard_1830
#'
#' @format A data frame with 957327 rows and 2 variables:
#'
#' sentence_id
