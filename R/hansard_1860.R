...
#'
#' Hansard corpus data for the decade 1860. To also access information about speaker, date, and debate title, join this data frame with debate_metadata on
...
#' @usage hansard_1860
#'
#' @format A data frame with 1035152 rows and 2 variables:
#'
#' sentence_id
