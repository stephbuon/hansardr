#' The 19th-century British Parliamentary debates metadata for the decade 1810
#'
...
#' @docType data
#'
#' @usage debate_metadata_1810
#'
#' @format A data frame with 228348 rows and 5 variables:
#'
#' sentence_id
