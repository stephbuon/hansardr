#' The 19th-century British Parliamentary debates for the decade 1900
#'
#' Hansard corpus data for the decade 1900. To also access information about speaker, date, and debate title, join this data frame with debate_metadata on
...
#' @usage hansard_1900
#'
#' @format A data frame with 1817907 rows and 2 variables:
#'
#' sentence_id
