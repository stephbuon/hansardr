#' The 19th-century British Parliamentary debates speaker metadata for the decade 1810.
#'
...
#' @docType data
#'
#' @usage speaker_metadata_1810
#'
#' @format A data frame with 228348 rows and 6 variables:
#'
#' sentence_id
