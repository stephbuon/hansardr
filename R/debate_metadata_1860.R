#' The 19th-century British Parliamentary debates metadata for the decade 1860
#'
...
#' @docType data
#'
#' @usage debate_metadata_1860
#'
#' @format A data frame with 1035152 rows and 5 variables:
#'
#' sentence_id
