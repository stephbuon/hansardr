#' The 19th-century British Parliamentary debates speaker metadata for the decade 1890
#'
...
#' @docType data
#'
#' @usage speaker_metadata_1890
#'
#' @format A data frame with 1417769 rows and 6 variables:
#'
#' sentence_id
