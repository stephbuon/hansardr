#' The 19th-century British Parliamentary debates metadata for the decade 1830
#'
...
#' @docType data
#'
#' @usage debate_metadata_1830
#'
#' @format A data frame with 957327 rows and 3 variables:
#'
#' sentence_id
