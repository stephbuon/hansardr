...
#'
#' Hansard corpus data for the decade 1850. To also access information about speaker, date, and debate title, join this data frame with debate_metadata on
...
#' @usage hansard_1850
#'
#' @format A data frame with 985755 rows and 2 variables:
#'
#' sentence_id
